...
public class AccessoriesDAO implements IDAO<Accessories, Integer> {
    ...
    private static final String CHECK_EXIST_NAME = "SELECT COUNT(1) FROM dbo.Accessories WHERE name = ?";
    private static final String GET_ALL_ACTIVE = "SELECT * FROM dbo.Accessories WHERE status = 'active'";
    private static final String CHECK_ACCESSORY_TYPE_EXISTS_EXCEPT = "SELECT COUNT(1) FROM dbo.Accessories WHERE name = ? AND id != ?";

...
<body class="bg-light">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
                    <div class="container">
                        <a class="navbar-brand" href="#"><i class="fas fa-cogs me-2"></i>Accessories Management</a>
        ...
        <div class="main-container">
            ...
            <!-- Messages -->
            <c:if test="${not empty messageRemoveAccessory}">
                <div class="alert alert-success alert-dismissible fade show" role="alert">
                    <i class="fas fa-check-circle me-2"></i>${messageRemoveAccessory}
    ...
    <script>
        ...
        function confirmDelete(id, name) {
            ...
            document.getElementById('confirmDeleteBtn').href = 'ProductController?action=removeAccessory&id=' + id;
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (searchInput.value.trim() !== '') {
                ...
                clearBtn.onclick = function() {
                    searchInput.value = '';
                    window.location.href = 'ProductController?action=viewAllAccessories';
                };

<%-- Document : header Created on : May 12, 2025 Author : MSI PC --%> <%@ page
import="dto.Accounts"%> <%@ page contentType="text/html" pageEncoding="UTF-8"%>
...
<html>
  ...
  <body>
    <% Accounts user = (Accounts) session.getAttribute("user"); boolean
    loginCheck = user != null; String username = loginCheck ?
    (user.getUsername() != null ? user.getUsername() : "Admin") : ""; String

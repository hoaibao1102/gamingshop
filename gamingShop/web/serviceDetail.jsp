    ...
    <head>
      ...
      ========================= */
            ...
            * {
            ...
            .sd-desc-content table td,
            .sd-desc-content table th {
            ...
            <div class="Main_content">
                ...
                <div class="container">
                    <div class="breadcrumbs">
                        <a href="${pageContext.request.contextPath}/MainController?action=listDichVu">Danh sách dịch vụ</a>
                        <span>/</span>
                            ...
                            <div class="service-detail">
                                ...
                                <div class="sd-right">
                                    ...
                                    <div class="sd-actions">
                                        <!-- vẫn dùng id khi gửi sang Zalo vì chỉ là hiển thị/format -->
                                        <button
                                            onclick="bookService('${serviceDetail.id}', '${serviceDetail.service_type}', '${serviceDetail.price}')"
                                            class="btn-service btn-primary"
                                            >
                                            🛒 Đặt dịch vụ qua Zalo
                                        </button>
                                        <button
                                            onclick="callDirectly()"
                                            class="btn-service btn-secondary"
                                            >
                                            📞 Gọi trực tiếp
                                        </button>
                                        <a
                                            href="${pageContext.request.contextPath}/MainController?action=listDichVu"
                                            class="btn-service btn-secondary"
                                            >
                                            📋 Xem dịch vụ khác
                                        </a>
                                    ...
                                    <c:if test="${not empty serviceDetail.description_html}">
                                        <div class="sd-desc">
                                            <div class="sd-desc-title">Mô tả chi tiết dịch vụ</div>
